...
export const PALETTE = {
  ...
  fog: 0x38424f, fogDensity: 0.0075,
  hemiSky: 0x8fa3bf, hemiGround: 0x2e2a24, hemiIntensity: 0.85,
  sunColor: 0xe8b45f, sunIntensity: 1.1, sunPos: [60, 100, 20] as const, // 灯火暖光
