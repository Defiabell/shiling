...
export const EXPLORE_BASE_EVENTS: readonly TaleEvent[] = [
...

  {
    ...
    trigger: {
      ...
      once: true,
      /*
       * [S2] 权重 44 → **14**：这不是「觉得它该稀有一点」，是**池子变小了**。
       ...
       *
       * 中途试过 22（占比 ≈8.8%，理论上等于拆池之前），实测 cautious 的成道率仍是
       * **15.4%**（n=1500 复量 15.5%，不是噪声）—— 因为拆池同时把兽径的灵／德来源
       * 也浓缩了一倍，光把这一条拉回原占比不够。14 落在 5〜6%，三个画像才一起进界。
       * 复算：`pnpm -C packages/gen balance --lives 500 --profile cautious`。
       */
      weight: 14,
      tags: [EV_WONDER],
    },
        ...
        outcomes: [
          {
            ...
            effects: { takesLife: 1, devourDivine: true,
              hunger: 40,
          ...
          },
          {
            ...
            effects: { takesLife: 1, devourDivine: true, hunger: 20, essence: { meng: 16 }, stats: { ti: -8, de: -6 } },
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: { takesLife: 3, hunger: 26, essence: { zu: 12 }, stats: { de: -3 } },
          },
        ],
      },
      {
        ...
        outcomes: [
          {
            ...
            effects: { takesLife: 1, hunger: 12, essence: { zu: 4 }, stats: { ling: 1, de: 1 } },
          },
        ],
      },
      {
